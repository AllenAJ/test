...
const IndexPage = () => (
  <div>
     <img alt="zubi-logo" src={zubi_logo} />
    ...
    <h3>Step 1</h3>
    <p>
      Goto the <a target="_blank" href="https://github.com/Zubi-io"> GitHub repository </a> of this project and fork the project to your account. <i className="em em-knife_fork_plate"></i>
      ...
      <Code code="https://github.com/Zubi-io"/>
    </p>
    <h3>Step 2</h3>
    <p>
      ...
      <Code code="git clone https://github.com/YOUR_USERNAME/zubi.git"/>
    </p>
    <h3>Step 3</h3>
    <p>
      ...
      we'll simply give the name of the branch as above. eg: <i>git branch zubi</i>. Once you have created the new branch we'll change the current brach from master to your newly created branch.
    ...
    <p>
      ...
      It should look like <b>YOUR_USER_NAME.md</b> <i>eg: allen.md </i><br/>
